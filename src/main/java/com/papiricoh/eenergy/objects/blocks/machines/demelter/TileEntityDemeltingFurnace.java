...
public class TileEntityDemeltingFurnace extends TileEntity implements ITickable
{
	...
	public static boolean isBurning(TileEntityDemeltingFurnace te) 
	{
	...
	{	
		...
		{
			--this.burnTime;
			BlockDemeltingFurnace.setState(true, world, pos);
		}
		...
		else
		{
			...
			{
				ItemStack output = DemeltingFurnaceRecipes.getInstance().getDemeltingResult(inputs[0], inputs[1]);
				if(!output.isEmpty())
				{
					smelting = output;
					cookTime++;
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = DemeltingFurnaceRecipes.getInstance().getDemeltingResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));	
